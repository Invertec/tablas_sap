...
# Campos que deseas leer de la tabla EKPO
fields = ['EBELN', 'EBELP', 'UNIQUEID', 'AEDAT', 'TXZ01', 'MATNR', 'EMATN', 
          'BUKRS', 'WERKS', 'MATKL', 'KTMNG', 'MENGE', 'BPUMZ', 'BPUMN', 
          'UMREZ', 'UMREN', 'NETPR', 'PEINH', 'NETWR', 'BRTWR', 'PRDAT', 'EFFWR']
...
df.to_sql('EKPO_Data', con=engine, if_exists='replace', index=False)
