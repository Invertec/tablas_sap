...
# Campos que deseas leer de la tabla EBAN
fields = ['MANDT', 'BANFN', 'BNFPO', 'BSART', 'BSTYP', 'BSAKZ', 
          'LOEKZ', 'STATU', 'ESTKZ', 'FRGKZ', 'FRGZU', 'FRGST', 
          'EKGRP', 'ERNAM', 'ERDAT', 'AFNAM', 'MATNR', 'WERKS', 'LGORT', 'BEDNR']

# Llamada a la función RFC para la tabla EBAN
...
df.to_sql('EBAN_Data', con=engine, if_exists='replace', index=False)
