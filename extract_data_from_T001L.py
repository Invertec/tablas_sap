...
def fetch_T001L_data():
    ...
    # Leer los campos para la tabla T001L
    fields = config['fields']['T001L']

    # Llamada a la función RFC para la tabla T001L
    ...
    save_to_database(df, 'T001L_Data')
