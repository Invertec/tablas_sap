...
def fetch_T003T_data():
    ...
    # Leer los campos para la tabla T003T
    fields = config['fields']['T003T']

    # Llamada a la función RFC para la tabla T003T
    ...
    save_to_database(df, 'T003T_Data')
