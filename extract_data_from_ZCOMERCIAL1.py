...
def fetch_ZCOMERCIAL1_data():
    ...
    # Leer los campos para la tabla ZCOMERCIAL1
    fields = config['fields']['ZCOMERCIAL1']

    # Llamada a la función RFC para la tabla ZCOMERCIAL1
    result = sap_conn.call('RFC_READ_TABLE',
                            QUERY_TABLE='ZCOMERCIAL1',
                            DELIMITER='|',
    ...
    save_to_database(df, 'ZCOMERCIAL1_Data')
